...
TEST(FunctionTesting, testIsrluNegative) {
    double alpha = 0.5;
    EXPECT_NEAR(isrlu(-2.5, alpha), -1.4744195615489712, 1e-2);
...
TEST(FunctionTesting, testIsrluPositive) {
    double alpha = 0.5;
    EXPECT_NEAR(isrlu(1.8, alpha), 1.8, 1e-3);
    EXPECT_NEAR(isrlu(0.2, alpha), 0.2, 1e-3);
    EXPECT_NEAR(isrlu(0.56, alpha), 0.56, 1e-3);
}

TEST(FunctionTesting, testIsrluZero) {
    double alpha = 0.5;
    EXPECT_NEAR(isrlu(0, alpha), 0, 1e-3);
    EXPECT_NEAR(isrlu(0.1, alpha), 0.1, 1e-3);
    EXPECT_NEAR(isrlu(0.0, alpha), 0.0, 1e-3);
}
